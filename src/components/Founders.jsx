...
export default function Founders() {
  ...
  return (
    <section className="foundersSection w-full min-h-screen bg-black relative overflow-hidden">
      {/* Background effect */}
      <LiquidEther
      ...
      <div className=" inset-0 flex items-center justify-center px-4 py-20 !mt-[100px]">
