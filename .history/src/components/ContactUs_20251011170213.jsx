...
export default function ContactUs() {
  return (
    ...
    >
      ...
      <div className="content flex flex-col md:flex-row items-center justify-start relative w-full h-full ">
        <div className="mapContainer flex items-center justify-center mt-4 top-0.5 right-0">
          <img
        ...
        <form className="formContainer flex flex-col items-center justify-center mt-4 md:ml-[55%] z-10">
          <input type="text" placeholder="Your Name" className="mb-4 p-2 border border-black-300 rounded" />
