    ...
    return (
      <div className="w-screen h-[50vh] contactCards flex flex-col md:flex-row items-center justify-center gap-8 p-4 overflow-x-auto">
        ...
        <div className="findUs">
          <p>Find us here </p>
          <div className="flex items-center justify-center text-[30px] text-white bg-black rounded-full w-[50px] h-[80px]">
            <i className="fa-brands fa-facebook"></i>
          </div>{" "}
          <div className="flex items-center justify-center text-[30px] text-white bg-black rounded-full w-[80px] h-[80px]">
