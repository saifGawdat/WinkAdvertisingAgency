...
export default function Projects() {
  ...
  useEffect(() => {
    ...
    function onEnd() {
      ...
      // More sensitive threshold for better swipe detection
      const threshold = Math.min(50, (containerWidthRef.current || window.innerWidth) * 0.08);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Remove the side buttons and keep only dots */}
