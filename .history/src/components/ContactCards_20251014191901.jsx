      ...
      <div className="flex-col flex items-center justify-center gap-4 ">
        <div className="w-screen h-[50vh] contactCards flex flex-col md:flex-row items-center justify-center gap-8 p-4 overflow-x-auto">
          <div className="card bg-black w-[300px] h-[300px] text-white rounded-[30px] p-[40px]  flex flex-col items-center justify-center gap-2 max-[400px]:w-[250px] max-[400px]:h-[250px]">
            ...
            <h4 className="text-xl font-bold max-[]:">Email</h4>
            <p className="font-semibold text-lg max-[]:">winkadv.agency@gmail.com</p>
          </div>
          <div className="card bg-black w-[300px] h-[300px] text-white rounded-[30px] p-[40px]  flex flex-col items-center justify-center gap-2 max-[400px]:w-[250px] max-[400px]:h-[250px]">
            <div className="flex items-center justify-center text-[40px] text-black bg-white rounded-full w-[80px] h-[80px] max-[400px]:text-[20px] max-[400px]:w-[40px] max-[400px]:h-[40px]">
              <i className="fa-solid fa-phone"></i>
            </div>{" "}
            <h4 className="text-xl font-bold max-[]:">Phones</h4>
            <p className="font-semibold text-lg max-[]:">(+20) 114 633 9518</p>
            <p className="font-semibold text-lg max-[]:">(+20) 109 895 5668</p>
          </div>
          <div className="card bg-black w-[300px] h-[300px] text-white rounded-[30px] p-[40px]  flex flex-col items-center justify-center gap-2 max-[400px]:w-[250px] max-[400px]:h-[250px]">
            <div className="flex items-center justify-center text-[40px] text-black bg-white rounded-full w-[80px] h-[80px] max-[400px]:text-[20px] max-[400px]:w-[40px] max-[400px]:h-[40px]">
              <i className="fa-solid fa-location-dot"></i>
            </div>{" "}
            <h4 className="text-xl font-bold max-[]:">Address</h4>
            <p className="font-semibold text-lg text-center max-[]:">
