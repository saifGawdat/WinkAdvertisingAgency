...
export default function AboutUs() {
  ...
  return (
    <section
      id="aboutUs"
      className="relative w-screen h-screen bg-black shadow-2xl flex justify-center items-center overflow-visible !mt-[280px] max-[1050px]:!mt-[200px] max-[400px]:!mt-[100px]"
    >
      <LiquidEther
        colors={["#fff", "#FffC", "#ffF"]}
        mouseForce={20}
      ...
      <div className="accordionContainer relative z-[100] flex flex-col items-center justify-center w-full max-w-[1200px] mx-auto px-8">
        <h2 className="text-white font-bold text-6xl mb-20 text-center">
          About Us
        </h2>
        ...
        <div className="w-full space-y-8">
          ...
          <details className="group">
            <summary className="flex justify-between items-center cursor-pointer list-none text-white p-8 bg-transparent border-b-2 border-white/20 hover:border-white/60 transition-all duration-300 text-2xl">
            ...
            <div className="text-white/80 p-8 bg-transparent animate-slideDown text-xl mt-4">
              ...
              daily life, making digital interactions more intuitive and
              meaningful.
            </div>
          </details>
