...
export default function TeamMembers() {
  ...
  return (
    <div
      ref={containerRef}
      className="flex flex-wrap gap-[30px] justify-center items-center bg-black"
    >
      {team.length === 0 ? (
        <p>Loading...</p>
        ...
        visibleTeam.map((member, idx) => {
          ...
          return (
            <div
              ...
              className="team-card text-center flex flex-col items-center justify-center gap-[5px] overflow-hidden"
            >
              <img
                src={imgSrc}
