        ...
        visibleTeam.map((member, idx) => {
          ...
          return (
            <div
              ...
              className="team-card text-center flex flex-col items-center justify-center gap-[5px] h-[250px] w-[45%] sm:w-auto"
            >
              <img
                src={imgSrc}
                alt={member.name || `member-${originalIdx}`}
                className="w-[150px] h-[350px] object-fit rounded-[40px]"
              />
