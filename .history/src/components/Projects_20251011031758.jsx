...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      <button className="border-bg-black text-white !py-[12px] !px-[25px] !w-[250px] rounded-[30px] hover:bg-white hover:text-black hover:border-black hover:border-[2px] cursor-pointer transition-all duration-300">
        See More
      </button>
    </section>
  );
