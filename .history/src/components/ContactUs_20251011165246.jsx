    ...
    >
      ...
      <div className="relative w-full h-full flex items-center justify-center mt-4 top-0.5 right-0">
        ...
        <img
          ...
          alt="map background"
          className="w-[40%] h-[80%] object-cover  absolute top-0.5 left-0"
        />
        <div className="absolute top-[10%] left-[5%] shadow-2xl rounded-2xl overflow-hidden border-4 border-white z-20">
          <iframe
