...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={wrapperRef}
        className="w-full max-w-[100%] mx-auto relative overflow-hidden"
        style={{
          touchAction: "pan-y",
      ...
      >
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 bottom-6 flex justify-center items-center gap-3 z-20 overflow-hidden">
          {projects.map((_, i) => (
            <button
              key={i}
              onClick={() => setIndex(i)}
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 overflow-hidden ${
                i === index
