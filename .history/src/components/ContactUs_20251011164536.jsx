    ...
    >
      ...
      <div className="relative w-full h-full flex items-center justify-center mt-4">
        ...
        <img
          ...
          alt="map background"
          className="w-full h-4 object-cover absolute top-0 left-0"
        />

        {/* الخريطة العايمة */}
        <div className="absolute bottom-[-80px] sm:bottom-[-0px] shadow-2xl rounded-2xl overflow-hidden border-4 border-white z-20">
          <iframe
