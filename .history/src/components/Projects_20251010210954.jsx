...
export default function Projects() {
  ...
  if (loading)
    return (
      <section
        id="projects"
        className="w-screen min-h-screen flex items-center justify-center bg-white text-black"
      >
  ...
  return (
    <section
      id="projects"
      className="w-screen min-h-screen flex flex-col items-center justify-center bg-white text-black relative"
    >
