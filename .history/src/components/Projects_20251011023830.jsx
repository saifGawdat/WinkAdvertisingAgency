...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      <div className=" flex items-center justify-center w-[90vw] h-[90vw] mx-auto overflow-hidden">
        {/* Left arrow */}
        <button
          onClick={prevSlide}
        ...
        >
          {projects.map((project, i) => (
            ...
            >
              <div className="bg-white text-black rounded-2xl shadow-lg p-6 w-[100%] h-[100%] text-center relative ">
                <img
