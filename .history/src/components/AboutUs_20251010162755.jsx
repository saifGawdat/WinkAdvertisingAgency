...
export default function AboutUs() {
  ...
  return (
    <section
      id="aboutUs"
      className="relative w-screen h-screen bg-black flex items-center shadow-2xl justify-center overflow-visible !mt-[220px] max-[1050px]:!mt-[200px] max-[400px]:!mt-[100px]"
    >
      <LiquidEther
