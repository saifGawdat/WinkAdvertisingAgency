...
export default function AboutUs() {
  ...
  return (
    <section
      id="aboutUs"
      className="relative w-screen h-screen bg-black flex items-center shadow-[inset_0_0_100px_rgba(0,0,0,0.9)] justify-center overflow-visible !mt-[220px] max-[1050px]:!mt-[200px] max-[400px]:!mt-[100px]"
    >
      <LiquidEther
