...
export default function ContactUs() {
  return (
    ...
    >
      <h2 className="text-black text-center font-bold text-[32px] md:text-[48px] mt-[5px] z-10 overf">
        Contact Us
      </h2>
      ...
      <div className="relative w-full h-full flex items-center justify-center mt-4 top-0.5 right-0">
        ...
        <img
          ...
          alt="map background"
          className="w-[40%] h-[50%] object-cover  absolute top-0.5 left-0"
        />
        <div className="absolute bottom-0 right-0 shadow-2xl rounded-2xl overflow-hidden border-4 border-white z-20">
          <iframe
