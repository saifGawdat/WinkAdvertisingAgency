...
export default function Founders() {
  return (
    <section className="foundersSection flex flex-row flex-wrap w-screen h-screen bg-black">
      <LiquidEther
      ...
      />
      <div className="imgs flex flex-row relative top-[50%] right-[0%] w-[50%] h-[50%]">
