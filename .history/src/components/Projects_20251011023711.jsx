...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      <div className=" flex items-center justify-center w-[90vw] max-w-[900px] mx-auto overflow-hidden">
        {/* Left arrow */}
        <button
          onClick={prevSlide}
        ...
        >
          {projects.map((project, i) => (
            ...
            >
              <div className="bg-white text-black rounded-2xl shadow-lg p-6 w-[80%] text-center relative ">
                <img
