...
export default function ContactUs() {
  return (
    ...
    >
      ...
      {/* flex-row في الديسكتوب / flex-col في الموبايل */}
      <div className="flex flex-col md:flex-row items-center justify-start md:justify-between w-full h-full relative overflow-hidden md:!ml-[80px]">
        ...
        {/* الفورم */}
        <div className="formContainer w-[90%] md:w-[40%] h-auto md:h-full flex flex-col items-center justify-center bg-white/70 backdrop-blur-sm p-6 rounded-2xl md:rounded-l-2xl z-30 mt-6 md:mt-0">
          <form className="flex flex-col gap-4 w-full">
            <h2 className="font-bold text-black text-[28px] md:text-[40px] text-center">
            ...
            <textarea
              ...
              className="border-[3px] border-black p-2 rounded-lg text-black h-[200px] md:h-[250px]"
            ></textarea>
