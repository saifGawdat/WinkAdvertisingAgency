...
export default function AboutUs() {
  ...
  return (
    <section
      id="aboutUs"
      className="relative w-screen h-screen bg-black shadow-2xl flex items-center justify-center overflow-visible !mt-[280px] max-[1100px]:!mt-[50px] max-[700px]:!mt-[10px] max-[400px]:!mt-[100px]"
    >
      <LiquidEther
      ...
      <img
        ...
        src={cap}
        alt="cap"
        className="absolute top-0 left-[5%]  h-[80%] z-[9]"
      />

      <div className="absolute inset-0 flex items-center justify-center">
        <h2 className="absolute text-white font-bold text-5xl !mb-[50px] text-center !overflow-hidden !top-[100px] ">
          About Us
        </h2>
