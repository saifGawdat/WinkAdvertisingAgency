export default function ContactCards() {
    return (
      <div className="flex-col flex items-center justify-center gap-4 ">
        <div className="w-screen h-[50vh] max-[768px]:h-[100vh] max-[768px]:!-mt-[50px] contactCards flex flex-col md:flex-row items-center justify-center gap-8 p-4 overflow-x-auto">
