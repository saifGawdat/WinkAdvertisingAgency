...
export default function Founders() {
  return (
    <section className="foundersSection flex flex-row flex-wrap w-screen h-screen bg-black relative">
      ...
      />
      <div className="imgs flex flex-row absolute top-[50%] translate-x-1/2 -translate-y-1/2 w-[50%] h-[50%] gap-[20px] ">
        <div className="overflow-hidden flex flex-col items-center justify-center text-white">
          <img
            ...
            alt=""
          />
          <h3 className="overflow-hidden">Ebrahim Zaid</h3>
        ...
        <div className="overflow-hidden">
          <img
            ...
            alt=""
          />
          <h3 className=" className="overflow-hidden"">Eslam Yehia</h3>
          <p className=" className="overflow-hidden"">Founder</p>
        </div>
      </div>
