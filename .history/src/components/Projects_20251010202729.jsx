            ...
            return (
              ...
              >
                <div className="w-full px-6 py-8">
                  {/* Remove the grid, use flex column instead */}
                  <div className="max-w-[1100px] w-full mx-auto flex flex-col gap-8">
                    {/* Logo section */}
                    <div className="flex items-start justify-start">
                      <div className="w-[260px] h-[260px] md:w-[340px] md:h-[340px] rounded-2xl overflow-hidden flex items-center justify-center bg-white p-6">
                        <img
                          src={logo}
