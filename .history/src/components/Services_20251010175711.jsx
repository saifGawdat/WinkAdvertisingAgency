  ...
  const services = [
    {
      ...
      desc:
        "Brands nowadays are like people, there's just too many of them, each wants to look different and unique and to have its own looks and personality. We get to know your brand, inside and out.. tailor it to suit its character, to reach desired target segments with the right look.",
      img: bgImg,
    },
    {
      id: 2,
      title: "Web & Apps",
      desc:
        "Design and build responsive web and mobile applications focused on UX, performance and conversion.",
      img: bgImg,
    },
    {
      id: 3,
      title: "Marketing",
      desc:
        "Strategic campaigns, social media management and content that grows audiences and drives results.",
      img: bgImg,
    },
    {
      id: 4,
      title: "Visual Design",
      desc:
        "High-impact visuals, art direction and creative execution for digital & print touchpoints.",
      img: bgImg,
    },
    {
      id: 5,
      ...
      desc:
        "Research-led product planning and roadmaps to deliver measurable outcomes and product-market fit.",
      img: bgImg,
    },
    {
      id: 6,
      title: "Consulting",
      desc:
        "Business & creative consulting to align brand, product and growth strategies for long-term success.",
      img: bgImg,
    },
  ];
