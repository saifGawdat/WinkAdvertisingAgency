  ...
  return (
    ...
    >
      ...
      <div className="content flex flex-col md:flex-row items-center justify-start relative w-full h-full ">
        ...
        <div className="form w-50% h-full flex items-center justify-center mt-4 ml-[50%] z-50">
          <form action="">
            <h2 className="font-bold text-black">Ready to take your business to the next level?</h2>
          </form>
        </div>
      </div>
    </section>
