  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-start w-full h-full relative overflow-hidden !ml-[40px]">
        {/* الخريطة في الشمال */}
        <div className="mapContainer flex items-center justify-center w-[50%] h-full relative !mt-[10%]">
          <img
        ...
        <div className="formContainer w-[40%] h-full flex flex-col items-center justify-center bg-white/70 backdrop-blur-sm p-6 rounded-l-2xl z-30">
          <form className="flex flex-col gap-4 w-full">
            ...
            <input
              ...
              className="border border-gray-400 p-2 rounded-lg text-black required:"
            />
            <input
              type="email"
              placeholder=" Email"
            ...
            <textarea
              ...
              className="border border-gray-400 p-2 rounded-lg h-[100px] text-black"
            ></textarea>
            <button
              type="submit"
