...
export default function ContactUs() {
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-start w-full h-full relative overflow-hidden !ml-[40px]">
        {/* الخريطة في الشمال */}
        <div className="mapContainer flex items-center justify-center w-[50%] h-full relative !mt-[15%]">
          <img
            src="src/assets/map.webp"
            alt="map background"
            className="w-[60%] h-[60%] object-cover absolute top-0.5 left-0 rounded-2xl"
          />
        ...
        <div className="formContainer w-[40%] h-full flex flex-col items-center justify-center bg-white/70 backdrop-blur-sm p-6 rounded-l-2xl z-30">
          <form className="flex flex-col gap-4 w-full">
            ...
            <input
              ...
              required
              className="border-[3px] border-black p-2 rounded-lg text-black "
            />
            <input
            required
              type="email"
            ...
            required
              ...
              className="border-[3px] border-black p-2 rounded-lg h-[100px] text-black"
            ></textarea>
            <button
              type="submit"
              className="bg-black text-white px-[30px] py-[5000px] w-[200px] rounded-full hover:bg-gray-800 transition-all duration-300"
            >
              Send Message
            </button>
          </form>
