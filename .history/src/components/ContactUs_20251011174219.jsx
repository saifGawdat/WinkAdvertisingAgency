      ...
      <div className="flex flex-col md:flex-row items-center md:justify-center justify-start w-full md:max-w-[90vw] h-full relative md:gap-8 overflow-hidden md:px-4">
        ...
        <div className="mapContainer flex items-center justify-center w-full md:w-[45vw] md:max-w-[700px] h-[400px] md:h-[500px] relative p-4 md:p-0 overflow-hidden flex-shrink-0">
          <img
            ...
            alt="map background"
            className="hidden md:block w-full h-full object-cover absolute rounded-2xl"
          />
        ...
        {/* الفورم */}
        <div className="formContainer w-full md:w-[45vw] md:max-w-[600px] min-h-screen md:min-h-0 md:max-h-[500px] flex flex-col items-center justify-center bg-white/70 backdrop-blur-sm p-6 md:rounded-2xl z-30 overflow-y-auto overflow-x-hidden flex-shrink-0">
          <form className="flex flex-col gap-4 w-full md:max-w-[450px]">
            <h2 className="font-bold text-black text-[24px] md:text-[40px] text-center !overflow-hidden h-[600px]">
              Ready to take your business to the next level?
            </h2>
            <p className="text-sm md:text-base h-[400px] mt-[20px] mb-[10px] text-center">
