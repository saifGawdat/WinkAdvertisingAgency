...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="projects py-24 flex flex-col items-center justify-center relative h-screen w-screen"
    >
      {projects.map((project, index) => (
        <div key={project.id} className="project-card">
          <img src={logos[index]} alt={project.name} className="project-logo" />
          <h3 className="project-title">{projecst.name}</h3>
