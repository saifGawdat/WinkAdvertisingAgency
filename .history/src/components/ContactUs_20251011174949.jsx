  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-center justify-start w-full md:max-w-[90vw] h-full relative md:gap-8 overflow-hidden md:px-4">
        ...
        <div
          ref={mapRef}
          className="mapContainer flex items-center justify-center w-full md:w-[45vw] md:max-w-[700px] h-[400px] md:h-[500px] relative p-4 md:p-0 overflow-hidden flex-shrink-0"
        >
          <img
        ...
        <div
          ref={formRef}
          className="formContainer w-full md:w-[45vw] md:max-w-[600px] min-h-screen md:min-h-0 md:h-[500px] flex flex-col items-center justify-start bg-white/70 backdrop-blur-sm p-4 md:p-6 md:rounded-2xl z-30 overflow-y-auto overflow-x-hidden flex-shrink-0"
        >
          <div className="flex flex-col gap-3 w-full md:max-w-[450px]">
