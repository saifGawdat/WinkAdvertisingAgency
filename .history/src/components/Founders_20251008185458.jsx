...
export default function Founders() {
  ...
  return (
    <section className="foundersSection w-screen min-h-screen bg-black relative overflow-x-hidden">
      <LiquidEther
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4 lg:p-8">
        <div className="w-full max-w-[1400px] flex items-center justify-center">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 w-full">
            <div
              ref={cardsRef}
              className="flex flex-col md:flex-row gap-8 lg:gap-16 w-full px-4 md:px-8"
            >
              <div className="flex flex-col items-center text-white gap-6">
                <img
                  className="w-[300px] md:w-[450px] h-[300px] md:h-[450px] rounded-lg object-cover shadow-2xl"
